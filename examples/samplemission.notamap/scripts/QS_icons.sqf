...
_QS_ST_showMOS_range = 5000;									// NUMBER. Range in distance to show MOS on the map. Default 3500.
...
QS_ST_STR_text1 = 'Team details';								// STRING. Text shown when a player passes Mouse over Group leader (only if _QS_ST_groupInteractiveIcons = TRUE;)
